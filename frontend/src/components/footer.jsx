...
const Footer = () => {
    ...
    const departments = [
        { name: 'Computer Engineering', short: 'CE' },
        { name: 'Mechanical Engineering', short: 'ME' },
        { name: 'Electrical Engineering', short: 'EE' },
        { name: 'Civil Engineering', short: 'CVE' },
        { name: 'Architecture', short: 'AR' },
    ];
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-2">
                            {departments.map((dept) => (
                                <li key={dept.short}>
                                    <span className="text-sm text-gray-400 flex items-center gap-2 cursor-default">
