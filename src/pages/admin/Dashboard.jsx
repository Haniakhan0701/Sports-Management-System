...
const Dashboard = () => {
    const stats = [
        { label: 'Total Matches', value: '34', icon: 'bx-football', color: 'bg-blue-500', change: '+2 today' },
        { label: 'Completed', value: '21', icon: 'bx-check-circle', color: 'bg-green-500', change: '62% done' },
        { label: 'Live Now', value: '0', icon: 'bx-radio-circle', color: 'bg-red-500', change: 'No live matches' },
        { label: 'Upcoming', value: '13', icon: 'bx-time', color: 'bg-orange-500', change: 'Next: 3:00 PM' },
        { label: 'Registered Athletes', value: '200', icon: 'bx-group', color: 'bg-purple-500', change: '+12 this week' },
        { label: 'Announcements', value: '8', icon: 'bx-bell', color: 'bg-pink-500', change: '2 unread' },
    ];
