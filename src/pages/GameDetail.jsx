        ...
        <div className="min-h-screen bg-gray-50">
            ...
            >
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        {/* Header actions row — Back to Games (left) & Watch on YouTube (right) */}
                        <div className="flex items-center justify-between mb-6 mt-8 flex-wrap gap-3">
                            <Link to="/games">
                            ...
                            {game.videoFullUrl && (
                                <a
                                    ...
                                    className="flex items-center gap-2 bg-black/50 hover:bg-red-600 text-white text-sm font-semibold px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 shadow-lg"
                                >
