...
const Announcements = () => {
    ...
    // Categories for announcements with updated icons
    const categories = [
    ...
    // Priority levels with colors and appropriate icons
    ...
    return (
        ...
        >
            <div className="flex items-start gap-4">
                {/* Priority Icon with circular background */}
                <div className={`w-12 h-12 rounded-full ${priorityLevels[announcement.priority].circleBg} flex items-center justify-center flex-shrink-0`}>
                    <i className={`bx ${priorityLevels[announcement.priority].icon} text-xl text-white`}></i>
                </div>
