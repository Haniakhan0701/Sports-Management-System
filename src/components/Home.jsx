...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Announcements & Next Sports Week */}
            <section className="py-12 bg-gray-100">
                <div className="container mx-auto px-4">
            ...
            {/* Quick Action Grid — RANKINGS renamed to STANDINGS */}
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                        ...
                        {/* CHANGED: RANKINGS → STANDINGS, links to /standings */}
                        <Link to="/standings">
                            <div className="bg-gray-50 p-4 rounded-lg text-center hover:bg-gray-100 transition border border-gray-200">
                                <i className='bx bx-trophy text-2xl text-gray-600'></i>
                                <div className="font-medium text-gray-700 text-sm mt-1">STANDINGS</div>
                            </div>
                        </Link>
                        <Link to="/media">
                            <div className="bg-gray-50 p-4 rounded-lg text-center hover:bg-gray-100 transition border border-gray-200">
